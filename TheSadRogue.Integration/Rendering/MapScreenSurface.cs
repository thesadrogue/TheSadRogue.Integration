...
{
    /// <summary>
    /// A version of SadConsole's ScreenSurface suitable for use as a backing field for an interface implementation.
    /// Meant to be used as the <see cref="Maps.RogueLikeMapBase.BackingObject"/> field for a map implementation.
    /// </summary>
    [DataContract]
    public partial class MapScreenSurface : MapScreenObject, IDisposable, IScreenSurface
    {
        [DataMember(Name = "Font")]
        [JsonConverter(typeof(SadConsole.SerializedTypes.FontJsonConverter))]
        private IFont _font;
        ...
        private SadConsole.Renderers.IRenderer _renderer;

        /// <inheritdoc/>
        public bool ForceRendererRefresh { get; set; }

        /// <inheritdoc/>
        public virtual string DefaultRendererName { get; } = SadConsole.Renderers.Constants.RendererNames.Default;

        /// <inheritdoc/>
        public SadConsole.Renderers.IRenderer Renderer
        {
            get => _renderer;
            protected set
            {
        ...
        private readonly IScreenSurface _surfaceOwningObject;
        ...
        /// </param>
        public MapScreenSurface(int width, int height, IScreenObject owningObject = null) : this(width, height, width, height, null, owningObject)
        {
        ...
        /// field.  Otherwise, null.
        /// </param>
        public MapScreenSurface(int width, int height, ColoredGlyph[] initialCells, IScreenObject owningObject = null) : this(width, height, width, height, initialCells, owningObject)
        {
        ...
        /// field.  Otherwise, null.
        /// </param>
        public MapScreenSurface(int viewWidth, int viewHeight, int totalWidth, int totalHeight, IScreenObject owningObject = null) : this(viewWidth, viewHeight, totalWidth, totalHeight, null, owningObject)
        {
        ...
        /// field.  Otherwise, null.
        /// </param>
        public MapScreenSurface(IGridView<ColoredGlyph> surface, int visibleWidth = 0, int visibleHeight = 0, IScreenObject owningObject = null): this(new CellSurface(surface, visibleWidth, visibleHeight), owningObject: owningObject)
        {
        ...
        /// </param>
        [JsonConstructor]
        public MapScreenSurface(ICellSurface surface, IFont font = null, Point? fontSize = null, IScreenObject owningObject = null)
            : base(owningObject)
        {
            _surfaceOwningObject = owningObject as IScreenSurface ?? this;
            ...
            //
            Renderer = GameHost.Instance.GetRenderer(DefaultRendererName);
            RenderSteps.Add(GameHost.Instance.GetRendererStep(SadConsole.Renderers.Constants.RenderStepNames.Surface));
            RenderSteps.Add(GameHost.Instance.GetRendererStep(SadConsole.Renderers.Constants.RenderStepNames.Output));
            RenderSteps.Add(GameHost.Instance.GetRendererStep(SadConsole.Renderers.Constants.RenderStepNames.Tint));
        }
        ...
        /// field.  Otherwise, null.
        /// </param>
        public MapScreenSurface(int viewWidth, int viewHeight, int totalWidth, int totalHeight, ColoredGlyph[] initialCells, IScreenObject owningObject = null)
            : base(owningObject)
        {
            _surfaceOwningObject = owningObject as IScreenSurface ?? this;
        ...
        public override void Render(TimeSpan delta)
        {
            ...
            if (_renderer != null)
            {
                _renderer.Refresh(_surfaceOwningObject, ForceRendererRefresh);
                _renderer.Render(_surfaceOwningObject);
